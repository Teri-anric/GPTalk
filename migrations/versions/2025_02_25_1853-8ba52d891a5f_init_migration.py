...
Revision ID: 8ba52d891a5f
Revises: 
Create Date: 2025-02-25 18:53:07.335759
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("TEXT", "TOOL_CALL", name="messagetype"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.drop_table("chats")
    op.execute(sa.text("DROP TYPE IF EXISTS messagetype"))
    # ### end Alembic commands ###
